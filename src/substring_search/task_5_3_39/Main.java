...
public class Main {
    public static void main(String [] args) {
        ...
        System.out.println("Исходя из полученной информации о производительности каждого из алгоритмов следует практическое обоснование того факта, что выполнения алгоритмов зависит от многих факторов, и более примитивные алгоритмы при благоприятных условиях могут работать быстрее сложных. Стоит также отметить, что лучшее время показал алгоритм Кнута-Морриса-Пратта, работающий за ассимптотически линейное время.");
    }
}
